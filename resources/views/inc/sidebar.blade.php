        ...
        <li class="mb-1">
            ...
            <div class="collapse show" id="bookings-collapse">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="{{ route('categories.index') }}" class="link-body-emphasis d-inline-flex text-decoration-none rounded">Categories</a></li>
                    <li><a href="{{ route('subcategories.index') }}" class="link-body-emphasis d-inline-flex text-decoration-none rounded">Subcategories</a></li>
                    <li><a href="{{ route('products.index') }}" class="link-body-emphasis d-inline-flex text-decoration-none rounded">Products</a></li>
                </ul>
            </div>
        </li>
        <li class="mb-1">
